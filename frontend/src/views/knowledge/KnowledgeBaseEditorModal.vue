...
const initFormData = (type: 'document' | 'faq' = 'document') => {
  return {
    ...
    chunkingConfig: {
      ...
      chunkOverlap: 100,
      separators: ['\n\n', '\n', '。', '！', '？', ';', '；'],
      parentSeparators: [] as string[],
      childSeparators: [] as string[],
...
const buildSubmitData = () => {
  ...
  const data: any = {
    ...
    chunking_config: {
      ...
      parent_separators: formData.value.chunkingConfig.parentSeparators,
      child_separators: formData.value.chunkingConfig.childSeparators,
    ...
    if (props.mode === 'create') {
      ...
      const config: KBModelConfigRequest = {
        ...
        documentSplitting: {
          ...
          parentSeparators: data.chunking_config.parent_separators || [],
          childSeparators: data.chunking_config.child_separators || [],
